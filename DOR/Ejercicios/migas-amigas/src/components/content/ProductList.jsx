  ...
  return (
    <div>
      ...
      <div>
        {/* proudct */}
        <div>
            <img className="rounded-circle" src={bread} alt={t("homepage.product.name.bread")} width="200" height="200"/>
            <div>{t("homepage.product.name.bread")}</div>
            <div>{t("homepage.product.description.bread")}</div>
        </div>
        <div>
            <img className="rounded-circle" src={pastry} alt={t("homepage.product.name.pastry")} width="200" height="200"/>
            <div>{t("homepage.product.name.pastry")}</div>
            <div>{t("homepage.product.description.pastry")}</div>
        </div>
        <div>
            <img className="rounded-circle" src={empanada} alt={t("homepage.product.name.empanada")} width="200" height="200"/>
